...
try:
    ...
    system("python.exe -m pip install requests")
...
def snap(phone):
    ...
    try:
        ...
        if "OK" in snapR:
            Animate(f"{g}>>> [Snap] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def gap(phone):
    ...
    try:
        ...
        if "OK" in gapR:
            Animate(f"{g}>>> [Gap] {y}Code Was Sent.\n")
            return True
...
def tap30(phone):
    ...
    tap30D = {
        "credential": {"phoneNumber": f"0{phone.split("+98")[1]}", "role": "PASSENGER"}
    }
    ...
    try:
        ...
        if tap30R["result"] == "OK":
            Animate(f"{g}>>> [Tapsi] {y}Code Was Sent.\n")
            return True
...
def divar(phone):
    ...
    try:
        ...
        if divarR["authenticate_response"] == "AUTHENTICATION_VERIFICATION_CODE_SENT":
            Animate(f"{g}>>> [Divar] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def torob(phone):
    ...
    try:
        ...
        if torobR["message"] == "pin code sent":
            Animate(f"{g}>>> [Torob] {y}Code Was Sent.\n")
            return True  # torob
    except:
        pass
    gap
...
def snapfood(phone):
    ...
    try:
        ...
        if sfoodR["status"] == True:
            Animate(f"{g}>>> [SnapFood] {y}Code Was Sent.\n")
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR["success"] == True:
            Animate(f"{g}>>> [Sheypoor] {y}Code Was Sent.\n")
...
def okorosh(phone):
    ...
    try:
        ...
        if "success" in okR:
            Animate(f"{g}>>> [OfoghKourosh] {y}Code Was Sent.\n")
...
def alibaba(phone):
    ...
    try:
        ...
        if alibabaR["result"]["success"] == True:
            Animate(f"{g}>>> [AliBaba] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def smarket(phone):
    ...
    try:
        ...
        if smarketR["status"] == True:
            Animate(f"{g}>>> [SnapMarket] {y}Code Was Sent.\n")
...
def gapfilm(phone):
    ...
    try:
        ...
        if gaR["Code"] == 1:
            Animate(f"{g}>>> [GapFilm] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def sTrip(phone):
    ...
    try:
        ...
        if sTripR["status_code"] == 200:
            Animate(f"{g}>>> [Strip] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def filmnet(phone):
    ...
    try:
        ...
        if Filmnet["meta"]["operation_result"] == "success":
            Animate(f"{g}>>> [Filmnet] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def drdr(phone):
    ...
    try:
        ...
        if drdr["status"] == "success":
            Animate(f"{g}>>> [DrDr] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def itool(phone):
    ...
    try:
        ...
        if ok["success"] == True:
            Animate(f"{g}>>> [Itool] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def anar(phone):
    ...
    try:
        ...
        if ok["status"] == True:
            Animate(f"{g}>>> [AnarGift] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def azki(phone):
    ...
    try:
        ...
        if ok["messageCode"] == 201:
            Animate(f"{g}>>> [Azki] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def chmdon(phone):
    ...
    try:
        ...
        if ok["status"] == "ok":
            Animate(f"{g}>>> [Chamedoon] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def bn(phone):
    ...
    try:
        ...
        if ok["status"] == "success":
            Animate(f"{g}>>> [BaniMode] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def lendo(phone):
    ...
    try:
        ...
        if "تایید شماره تلفن همراه" in lendoR:
            Animate(f"{g}>>> [Lendo] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def olgoo(phone):
    ...
    try:
        ...
        if "مدت زمان باقی‌مانده تا دریافت مجدد کد" in olgoo:
            Animate(f"{g}>>> [NashrOlgoo] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def pakhsh(phone):
    ...
    try:
        ...
        if ok["code"] == "1":
            Animate(f"{g}>>> [PakhshShop] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def didnegar(phone):
    ...
    try:
        ok = post(timeout=5, url=paU, headers=paH, data=paD).json()
        if ok["code"] == "1":
            Animate(f"{g}>>> [DideNegar] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def baskol(phone):
    ...
    try:
        ...
        if ok["status"] == True:
            Animate(f"{g}>>> [Baskol] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def kilid(phone):
    ...
    try:
        ...
        if ok["status"] == "SUCCESS":
            Animate(f"{g}>>> [Kilid] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def basalam(phone):
    ...
    try:
        ...
        if ok.status_code == 200:
            Animate(f"{g}>>> [BaSalam] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def see5(phone):
    seD = {"mobile": f"0{phone.split("+98")[1]}", "action": "sendsms"}
    ...
    try:
        if ok == "send_sms":
            Animate(f"{g}>>> [See5] {y}Code Was Sent.\n")
            return True
...
def ghabzino(phone):
    ...
    try:
        ...
        if ok["Parameters"] != None:
            Animate(f"{g}>>> [Ghabzino] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def simkhanF(phone):
    ...
    try:
        ...
        if ok["Message"] == "ثبت نام شما با موفقیت انجام شد":
            Animate(f"{g}>>> [SimKhan] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def drsaina(phone):
    ...
    try:
        ...
        if "کد تایید 6 رقمی پیامک شده به شماره" in ok:
            Animate(f"{g}>>> [DrSaina] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def binjo(phone):
    ...
    try:
        ...
        if ok["status"] == "ok":
            Animate(f"{g}>>> [BinJo] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def limome(phone):
    ...
    try:
        ...
        if liR["status"] == "success":
            Animate(f"{g}>>> [Limome] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def bimito(phone):
    ...
    try:
        ...
        if liR["message"] == "کاربر قبلا ثبت نام نکرده است":
            Animate(f"{g}>>> [BimitoVip] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def seebirani(phone):
    ...
    try:
        ...
        Animate(f"{g}>>> [SeebIrani] {y}Code Was Sent.\n")
        return True
    except:
        pass
...
def mihanpezeshk(phone):
    ...
    try:
        ...
        Animate(f"{g}>>> [MihanPezeshk] {y}Code Was Sent.\n")
        return True
    except:
        pass
...
def mek(phone):
    ...
    try:
        ...
        if meR["isSuccess"]:
            Animate(f"{g}>>> [HamrahMechanik] {y}Code Was Sent.\n")
            return True
    except:
        pass
...
def Vip(phone, Time):
    ...
    sleep(Time)
    Thread(target=sheypoor, args=[phone]).start()
    sleep(Time)
    Thread(target=alibaba, args=[phone]).start()
    sleep(Time)
    Thread(target=smarket, args=[phone]).start()
    sleep(Time)
    Thread(target=sTrip, args=[phone]).start()
    sleep(Time)
    Thread(target=drdr, args=[phone]).start()
    sleep(Time)
    Thread(target=filmnet, args=[phone]).start()
    sleep(Time)
    Thread(target=itool, args=[phone]).start()
    sleep(Time)
    Thread(target=anar, args=[phone]).start()
    sleep(Time)
    Thread(target=azki, args=[phone]).start()
    sleep(Time)
    Thread(target=nobat, args=[phone]).start()
    sleep(Time)
    Thread(target=bn, args=[phone]).start()
    sleep(Time)
    Thread(target=baskol, args=[phone]).start()
    sleep(Time)
    Thread(target=basalam, args=[phone]).start()
    sleep(Time)
    Thread(target=ghabzino, args=[phone]).start()
    sleep(Time)
    Thread(target=okorosh, args=[phone]).start()
    sleep(Time)
    Thread(target=bimito, args=[phone]).start()
    sleep(Time)
    Thread(target=gapfilm, args=[phone]).start()
    sleep(Time)
    Thread(target=bimitoVip, args=[phone]).start()
    sleep(Time)
    Thread(target=seebirani, args=[phone]).start()
    sleep(Time)
    Thread(target=limome, args=[phone]).start()
    sleep(Time)
    Thread(target=binjo, args=[phone]).start()
    sleep(Time)
    Thread(target=kilid, args=[phone]).start()
    sleep(Time)
    Thread(target=didnegar, args=[phone]).start()
    sleep(Time)
    Thread(target=olgoo, args=[phone]).start()
    sleep(Time)
    Thread(target=chmdon, args=[phone]).start()
    sleep(Time)
    Thread(target=drsaina, args=[phone]).start()
    sleep(Time)
    # Thread(target=see5, args=[phone]).start()
    # sleep(Time)
    Thread(target=simkhanT, args=[phone]).start()
    sleep(Time)
    Thread(target=simkhanF, args=[phone]).start()
    sleep(Time)
    Thread(target=lendo, args=[phone]).start()
    sleep(Time)
    Thread(target=pakhsh, args=[phone]).start()
    sleep(Time)
    Thread(target=mihanpezeshk, args=[phone]).start()
    sleep(Time)
    Thread(target=mek, args=[phone]).start()
    sleep(Time)
...
# >>> | [!] {y}Info:                                     {g}|
# >>> |                                               |
# >>> |         [*] {y}Coder: {r}Arsalan-J                  {g}|
# >>> |         [*] {y}Channel: {r}@AxiomLite               {g}|
# >>> |                                               {g}|
# >>> |-----------------------------------------------|
# >>> |                                               |
# >>> | [!] {y}System:                                   {g}|
# >>> |                                               |
# >>> |           [*] {y}Platform: {r}{System}               {g}|
# >>> |           [*] {y}Release: {r}{Release}                     {g}|
# >>> |           [*] {y}Node: {r}{Node}           {g}|
# >>> |                                               |
# >>> |-----------------------------------------------|
# >>>
...
# while True:
#     phone = is_phone(input(f"{g}>>> [?] {r}Enter The Target Phone Number {r}[{y}+{g}98{r}]: {y}"))
#     if phone:
#         break
# try:
#     Time = float(input(f"{g}>>> [?] {r}Enter Sleep Time Between Requests [{g}Defult {r}= {y}0.1{r}]: {y}"))
#     Animate(f"{g}>>>\n>>> <{"-"*16}{y}Script Activeted{g}{"-"*16}>\n>>>\n")
# except ValueError:
#     Time = 0.1
#     Animate(f"{g}>>> [0.1] {y}Used\n")
# while True:
#     try:
#         Vip(phone, Time)
#     except KeyboardInterrupt :
#         exit(f"{g}>>> [-] {y}User Exited")
#     except:
#         Animate(f"{g}>>> [-] {y}Error TimeOut\n")
